...
namespace Majestic12
{
	...
	public class HTMLheuristics : IDisposable
	{
		...
		/// </summary>
        System.Collections.Generic.Dictionary<string, object> oAddedTags = new System.Collections.Generic.Dictionary<string, object>();
		...
		/// </summary>
        System.Collections.Generic.Dictionary<string, object> oAddedAttributes = new System.Collections.Generic.Dictionary<string, object>();
		...
		public bool AddTag(string p_sTag,string sAttributeNames)
		{
			...
			if(sTag.Length==0 || sTag.Length>32 || oAddedTags.ContainsKey(sTag))
				return false;
			...
			foreach(string p_sAName in sAttributeNames.ToLower().Split(','))
			{
				...
				if(oAddedAttributes.ContainsKey(sAName))
